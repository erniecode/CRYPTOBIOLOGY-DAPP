...
//ethers is used to interact with the etherium blockchain
//Big Number is: A BigNumber is an object which safely allows mathematical operations on numbers of any magnitude.
...
//Brings the type of Smart Contract we produced
import NftContractType from '../lib/NftContractType';
//Brings up all the configuraion we set for the Smart Contract
import CollectionConfig from '../../../../smart-contract/config/CollectionConfig';
import NetworkConfigInterface from '../../../../smart-contract/lib/NetworkConfigInterface';
//This is the widget to show up the collection status
import CollectionStatus from './CollectionStatus';
//This is the Widget to show the button to mint
...
//Interfaces receive functions and values provided by Logic Hooks and share them with other Logic Hooks or pass them as props to Pure Components.
//React components has a built-in state object. The state object is where you store property values that belongs to the component. When the state object changes, the component
//re-renders.

//Basically there are the variables to pass into the application
interface State {
...
//This Object Turns all the variables to its initial state
...
//This is what the app full component will return
export default class Dapp extends React.Component<Props, State> {
  //Get We3provider
  provider!: Web3Provider;
  //Type of contract
  contract!: NftContractType;
  //Get wallet type for owner if introduced manually
